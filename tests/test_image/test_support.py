...
class TestImageSupportProxy:
    def test_get_image_info(self, mocker):
        ...
        assert proxy._image_support.get_image_info.called
        assert  proxy._image_info is image_info
    ...
    def test_get_image_support(self, mocker, is_animated, format, support_patch):
        ...
        assert image_support_mock.called
        assert proxy._image_support is image_support
